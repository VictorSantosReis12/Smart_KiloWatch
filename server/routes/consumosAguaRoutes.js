...
router.put('/consumoAgua/setTempoUso/:idConsumoAgua', consumosAguaController.setTempoConsumoAgua);
router.put('/consumoAgua/setTipo/:idConsumoAgua', consumosAguaController.setTipoConsumoAgua);
