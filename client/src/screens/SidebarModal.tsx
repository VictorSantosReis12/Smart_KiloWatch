...
import { View, Image, useWindowDimensions, Text, TouchableOpacity, ScrollView } from 'react-native';
    ...
    return (
        isLandscape ?
            <>
                ...
                :
                <>
                    <Text style={{ color: colors.white, fontFamily: fontFamily.krona, fontSize: RFValue(6) }}>Modo Retrato</Text>
                </>
            </>
            :
            <>
