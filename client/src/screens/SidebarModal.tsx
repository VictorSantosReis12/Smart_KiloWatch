...
const Sidebar = ({ navigation }: any) => {
    ...
    return (
        <>
            {isLandscape ?
                <>
                    <View style={{ backgroundColor: colors.blue[400], width: "100%", height: "10%", justifyContent: "center", alignItems: "center", position: "absolute", top: 0, left: 0 }}>
                        <Image
                    ...
                    <DrawerArea
                        style={{ width: isOpen ? RFValue(140) : RFValue(40), backgroundColor: colors.blue[400], height: "90%", justifyContent: "flex-start", alignItems: "center", cursor: "default", position: "absolute", top: "10%", left: 0 } as any}
            ...
            {/* {isLandscape ?
                <>
                    <View 
                        style={{ flex: 1, justifyContent: "flex-start", width: "100%", height: "100%", position: "absolute", top: 0, left: 0, zIndex: isOpen ? 2000 : 0 }}
                        pointerEvents={"none"}
                    >
