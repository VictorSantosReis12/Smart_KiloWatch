        ...
        <Portal>
            ...
            <>
                <Modal
                    visible={visible}
                    onDismiss={onDismiss}
                    contentContainerStyle={[styles.modalContainer, { borderRadius: RFValue(20), height: RFValue(140) }]}
                >
                    <Text
                        variant="titleLarge"
                        style={[styles.title, { fontSize: RFValue(14) }]}
                    >
                        {changeText}
                    </Text>

                    <View style={{ width: RFValue(250), gap: RFValue(15), flexDirection: "row", justifyContent: "center", marginTop: RFValue(15) }}>
                        <Button
                            children={changeButtonCancelar}
                            compact
